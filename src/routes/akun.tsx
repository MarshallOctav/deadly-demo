...
export const Route = createFileRoute("/akun")({
  head: () => ({ meta: [{ title: "Akun - Deadly Store" }] }),
  component: AkunPage,
});
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-xl px-3 py-10 sm:px-4 sm:py-16">
        <div className="rounded-2xl border border-border bg-card p-6 text-center sm:p-8">
          ...
          <h1 className="mt-4 text-2xl font-black">Akun dinonaktifkan</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Semua order sekarang langsung lewat WhatsApp dan disimpan lokal.
          </p>
