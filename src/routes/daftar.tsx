...
export const Route = createFileRoute("/daftar")({
  head: () => ({ meta: [{ title: "Daftar - Deadly Store" }] }),
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-xl px-3 py-10 sm:px-4 sm:py-16">
        <div className="rounded-2xl border border-border bg-card p-6 text-center sm:p-8">
          <UserRoundPlus className="mx-auto h-10 w-10 text-primary" />
          <h1 className="mt-4 text-2xl font-black">Daftar akun ditutup</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Langsung pilih produk dan kirim order ke WhatsApp admin.
          </p>
